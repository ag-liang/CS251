...
my_private_key = CBitcoinSecret(
    'cReRgcENq8jfpP8Fe3gdMmtTVwd7JrkA5yM5VYsgJS11dXRga6ER'
)
...
alice_secret_key_BTC = CBitcoinSecret(
    'cRHhBaEMS8oecrQVHtMDCLaRjLH8rxSPU6Sk2M4xoZz7AjD1WVVx'
)

# Only to be imported by bob.py
bob_secret_key_BTC = CBitcoinSecret(
    'cPKcdy2rnyFNd7iPSKvt3PtzTyZkPrFjG83prCEnWmr1nzukDUyB'
)
...
alice_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('b3844695ad7dab18a972712a1fe20ea7313022ddd4ec6099b52da062e3705e0d'))

# Only to be imported by bob.py
# Bob should have coins!!
bob_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('4df7571f64595e8e163245aa2b4f6bf170e3f32f6728e9ec1aa9cdc5390a3753'))
