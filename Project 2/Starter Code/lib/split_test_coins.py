...
from config import (
    my_private_key, my_public_key, my_address,
    alice_secret_key_BTC, alice_public_key_BTC, alice_address_BTC,
    bob_secret_key_BTC, bob_public_key_BTC, bob_address_BTC,
    faucet_address, network_type
)
...
if __name__ == '__main__':
    ...
    amount_to_send = 0.00194   # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        '1856aa930028587b43eaa4cbf29ba319fc9fdbe989fd94b108f63865d60fd134')
